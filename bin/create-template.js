...
async function main() {
  ...
  await setupProject(projectPath, selectedPackages);
...
async function setupProject(projectPath, selectedPackages) {
  ...
  try {
    ...
    console.error('⚠️  Failed to install dependencies. Please run npm install manually.');
  }
